        ...
        <div className="flex items-center justify-center ">
            <div className="flex flex-col gap-2.5 px-8 pb-4 bg-[#171717] rounded-[25px] transition-all duration-400 hover:scale-105 hover:border hover:border-black min-w-[550px]">
                ...
                <div className="flex items-center gap-2 rounded-[25px] p-2.5" style={{ boxShadow: 'inset 2px 5px 10px rgb(5,5,5)' }}>
                    ...
                    <input autoComplete="off" placeholder="Username"  type="text" className="bg-transparent border-none outline-none w-full text-[#d3d3d3] text-sm"
                    {...register("email", {
                ...
                <div className="flex items-center gap-2 rounded-[25px] p-2.5" style={{ boxShadow: 'inset 2px 5px 10px rgb(5,5,5)' }}>
                    ...
                    <input placeholder="Password" type="password" className="bg-transparent border-none outline-none w-full text-[#d3d3d3] text-sm"
                    {...register("pws", {
